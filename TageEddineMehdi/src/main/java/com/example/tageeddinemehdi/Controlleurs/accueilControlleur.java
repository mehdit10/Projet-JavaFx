...
public class accueilControlleur {
    ...
    @FXML
    void btn_userA(ActionEvent event) throws IOException {
        Outils.load(event,"Gestionnaire des Utilisateur","/com/example/tageeddinemehdi/userAdmin.fxml");
    }

    @FXML
    void btn_vente(ActionEvent event) throws IOException {
        Outils.load(event,"Gestionnaire des ventes","/com/example/tageeddinemehdi/vente.fxml");

    }

    @FXML
    void btn_voiture(ActionEvent event) throws IOException {
        Outils.load(event,"Gestionnaire des Voitures","/com/example/tageeddinemehdi/voiture.fxml");
